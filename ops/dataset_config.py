...
def return_multimoments(modality):
    filename_categories = 313
    if modality == 'RGB':
        root_data = '/nobackup/users/bpan/multi-moments_256/multi-moment_256x256/'
        filename_imglist_train = 'multi-moments/trainingSetMultiFrames.txt'
        filename_imglist_val = 'multi-moments/validationSetMultiFrames.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix

def return_m4dataset(modality):
    filename_categories = 313
    if modality == 'RGB':
        root_data = '/nobackup/users/bpan/multi-moments_256/multi-moment_256x256/'
        filename_imglist_train = 'm4dataset/M4_trainingSetMultiFrames.txt'
        filename_imglist_val = 'm4dataset/M4_validationSetMultiFrames.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'multi-moments': return_multimoments, 'm4dataset': return_m4dataset}
